...
<TABLE class=Menu cellSpacing=0>
  ...
  <TBODY>
  <TR>
    <TH onClick="javascript:menu_tree('left_21');" align=middle>≡ 新闻系统 ≡</TH></TR>
  <TR id=left_21 style="display:none;">
    <TD>
      <TABLE width="100%">
        <TBODY>
      <TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="news_add.php?f_id=3" target=main>添加公司公告</A></TD>
		</TR>
		        <TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="news_manage.php?f_id=3" target=main>管理公司公告</A></TD>
		</TR>
		<TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		...
		<TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="news_add.php?f_id=5" target=main>添加行业新闻</A></TD>
		</TR>
		        <TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="news_manage.php?f_id=5" target=main>管理行业新闻</A></TD>
		</TR>
  ...
  <TBODY>
  <TR>
    <TH onClick="javascript:menu_tree('left_31');" align=middle>≡ 加入我们 ≡</TH></TR>
  <TR id=left_31 style="display:none;">
    <TD>
      <TABLE width="100%">
        <TBODY>
      <TR>
  ...
  <TBODY>
  <TR>
    <TH onClick="javascript:menu_tree('left_30');" align=middle>≡ 页面管理 ≡</TH></TR>
  <TR id=left_30 style="display:none;">
    <TD>
      <TABLE width="100%">
        <TBODY>
		<TR>
